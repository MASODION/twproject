<?php
    ...
    if(isset($_POST['email']) && isset($_POST['pass'])) {
        ...
        $query = $conn->prepare("SELECT a.userID, a.userFirstName, a.userLastName, a.userEmail, a.userPhoneNumber, a.userType, b.typeName, b.typeLevel FROM users a INNER JOIN users_types b ON a.userType = b.typeID WHERE a.userEmail = '$email' AND a.userPassword = '$pass'");
        $query->execute();
